...
sourcesIndex["env_logger"] = {"name":"","dirs":[{"name":"filter","dirs":[],"files":["mod.rs","regex.rs"]},{"name":"fmt","dirs":[{"name":"humantime","dirs":[],"files":["mod.rs","shim_impl.rs"]},{"name":"writer","dirs":[{"name":"termcolor","dirs":[],"files":["mod.rs","shim_impl.rs"]}],"files":["atty.rs","mod.rs"]}],"files":["mod.rs"]}],"files":["lib.rs"]};
...
sourcesIndex["serde_mtproto"] = {"name":"","dirs":[],"files":["de.rs","error.rs","helpers.rs","identifiable.rs","lib.rs","ser.rs","sized.rs","utils.rs","wrappers.rs"]};
sourcesIndex["serde_mtproto_derive"] = {"name":"","dirs":[],"files":["ast.rs","ext.rs","identifiable.rs","lib.rs","macros.rs","sized.rs"]};
